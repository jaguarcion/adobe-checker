...
export function ResultsTable() {
  ...
  const [filter, setFilter] = useState<'all' | 'good' | 'bad' | 'other'>('all');
      ...
      <div className="grid grid-cols-4 gap-4">
        ...
        >
          <CardContent className="p-4 text-center">
            <div className="text-2xl font-bold text-emerald-600"><AnimatedCounter value={stats.good} /></div>
        ...
        >
          <CardContent className="p-4 text-center">
            <div className="text-2xl font-bold text-rose-600"><AnimatedCounter value={stats.bad} /></div>
        ...
        >
          <CardContent className="p-4 text-center">
            <div className="text-2xl font-bold text-amber-600"><AnimatedCounter value={stats.other} /></div>
        ...
        >
          <CardContent className="p-4 text-center">
            <div className="text-2xl font-bold text-slate-700"><AnimatedCounter value={stats.total} /></div>
